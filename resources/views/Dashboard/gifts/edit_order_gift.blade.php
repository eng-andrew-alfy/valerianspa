                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xl-4 m-b-30">
                        ...
                        <input type="text" name="order_code" class="form-control"
                               value="{{$gift->order->order_code}}" required readonly>
                        <br>
                        @error('code')
                    ...
                    <div class="col-sm-12 col-xl-4 m-b-30">
                        ...
                        <select name="client_status" id="client_status" class="js-example-rtl col-sm-12" required>
                            <option disabled selected>العميل الحالى</option>
                    ...
                    <div class="col-sm-12 col-xl-4 m-b-30" id="existing_client_fields">
                        ...
                        <input type="text" name="existing_client_code" class="form-control"
                               value="{{$gift->recipient->code}}" readonly/>
                        <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xl-3 m-b-30">
                        ...
                        <select name="booking_type" id="booking_type" class="js-example-rtl col-sm-12" required
                                disabled>
                            @if($gift->order->package_id != null)
                                <option value="package" selected disabled>
                                    باقات
                                </option>
                            @else
                    ...
                    <div class="col-sm-12 col-xl-3 m-b-30">
                        ...
                        @if($gift->order->package_id == null)
                            <select class="js-example-rtl col-sm-12" name="categories" id="categories">
                                <option value="{{ $gift->order->category->id }}" disabled selected>
                                    {{ $gift->order->category->getTranslation('name', 'ar') }}
                                </option>
                            </select>
                        @else
                            <select class="js-example-rtl col-sm-12" name="categories" id="categories" disabled>
                    ...
                    <div class="col-sm-12 col-xl-3 m-b-30">
                        ...
                        @if($gift->order->package_id != null)
                            <select class="js-example-rtl col-sm-12" name="packages" id="packages">
                                <option value="{{ $gift->order->package->id }}" disabled selected>
                                    {{ $gift->order->package->getTranslation('name', 'ar') }}
                                </option>
                            </select>
                        @else
                            <select class="js-example-rtl col-sm-12" name="packages" id="packages" disabled>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function areAllFieldsFilled() {
                ...
                return latitude !== '' && longitude !== '' && (categoryId !== '' || packageId !== '') && date !== '';
            }
            ...
            $('#latitude, #longitude, #dropper-max-year').on('change', filterEmployees);
        ...
        $(document).ready(function () {
            function toggleReadonlyFields() {
                ...
                if (bookingType === 'package') {
                    ...
                    // Reset to the default option for packages
                    ...
                    // Reset to the default option for categories
