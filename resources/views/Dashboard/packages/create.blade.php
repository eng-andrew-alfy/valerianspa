...
@section('page-body')
    <div class="card">
        <div class="card-block">
            <form id="addPlaceForm" action="{{ route('admin.AllPackages.store') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xl-3 m-b-30">
                        ...
                        <input type="text" name="name_en" id="name_en" class="form-control"
                            placeholder="يرجى كتابة اسم الباقة بالانجليزية" value="{{ old('name_en') }}" required>
                        <br>
                        @error('name_en')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-sm-6 col-xl-3 m-b-30">
                        ...
                        <input type="text" class="form-control" name="time" placeholder="يرجى كتابة المدة بالدقائق"
                            pattern="\d+" title="يرجى إدخال أرقام فقط" value="{{ old('time') }}" required>
                        <br>
                        @error('time')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-sm-12 col-xl-3 m-b-30">
                        ...
                        <input type="text" name="num_sessions" class="form-control" placeholder="يرجى كتابة عدد الجلسات"
                            pattern="\d+" title="يرجى إدخال أرقام فقط" value="{{ old('num_sessions') }}" required>
                        <br>
                        @error('num_sessions')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xl-4 m-b-30">
                        ...
                        <select class="js-example-rtl col-sm-12" name="work_location[]" multiple="multiple">
                            <option value="home" @if (is_array(old('work_location')) && in_array('home', old('work_location'))) selected @endif>
                                خدمات منزلية
                            </option>
                            <option value="spa" @if (is_array(old('work_location')) && in_array('spa', old('work_location'))) selected @endif>
                                خدمات داخل الفرع
                            </option>
                        </select>
                        <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xl-4 m-b-30">
                        ...
                        <textarea class="form-control" name="description_ar" id="description_ar" rows="3" placeholder="الوصف عربى">{{ old('description_ar') }}</textarea>
                        <br>
                    ...
                    <div class="col-sm-12 col-xl-4 m-b-30">
                        ...
                        <textarea class="form-control" name="description_en" id="description_en" rows="3"
                            placeholder="الوصف انجليزي">{{ old('description_en') }}</textarea>
                        <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xl-4 m-b-30">
                            ...
                            <div id="input-container-en">
                                <!-- Initial English Input Field -->
                                <div class="input-group mb-3">
                                    <input type="text" name="inputs_en[]" class="form-control"
                                        placeholder="يرجى كتابة الفوائد بالانجليزية" value="{{ old('inputs_en.0') }}">
                                </div>
                            </div>
                            <br>
                            @error('inputs_en')
                        ...
                        <div class="col-sm-12 col-xl-4 m-b-30 d-flex align-items-start">
                            <!-- Add and Remove Buttons in a separate column but aligned with the inputs -->
                            <div>
                ...
                <button type="submit" class="btn btn-primary" style="display: block; margin: 0 auto;">أضافة باقة <i
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleTagsInput(tagsInputContainerId, tagsInputId, hiddenInputName) {
                ...
                function updateHiddenTagsInput() {
                    hiddenTagsInput.value = tags.join(','); // تحديث القيمة لتشمل جميع التاجات
                }
            }
        ...
        $(document).ready(function() {
            ...
            $('.js-example-rtl[name="work_location[]"]').on('change', function() {
                ...
                if (workLocations.length > 0) {
                        ...
                        success: function(response) {
                            ...
                            if (response.length > 0) {
                                $.each(response, function(index, employee) {
                                    employeeSelect.append('<option value="' + employee
                    ...
                    employeeSelect.prop('disabled', true).empty().append(
                        '<option value="">يرجى اختيار الخدمة أولاً</option>');
                }
            });
        });
