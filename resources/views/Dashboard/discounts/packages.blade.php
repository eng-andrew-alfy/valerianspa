                ...
                <table id="lang-file" class="table table-striped table-bordered nowrap">
                    ...
                    @foreach($discounts as $discount)
                        <tr>
                            ...
                            <td class="text-center">{{ $discount->package->getTranslation('name', 'ar') }}</td>
                            <td class="text-center">{{ $discount->package->prices->at_home }}</td>
                            <td class="text-center">{{ $discount->package->prices->at_spa }}</td>
