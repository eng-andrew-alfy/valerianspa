    ...
    <div class="cart-container">
        <form id="bookingFormCategory" action="{{ route('PaymentMyFatoorah') }}" method="post">
            ...
            <div class="ms-form-container">
                ...
                {{--                                </div>--}}
                {{--                                <div class="price">--}}
                {{--                                    <span style="color: #136e81"--}}
                {{--                                          class="font-bold font-16">{{ $Data->category->prices->$price }}</span>--}}
                {{--                                    {{ __('cart.sar') }}--}}
                {{--                                </div>--}}
                {{--                            </div>--}}
                {{--                        </div>--}}
                ...
                <div style="line-height: 30px; font-size: 16px; margin-bottom: 30px" class="ms-price-card">
                    <div class="border-bottom-1 padding-bottom-10">
                        <div class="flex-row space-between" style="display: flex; justify-content: space-between;">
                            ...
                            <div
                                style="@if ($Data->category->discount) text-decoration-line: line-through; color: #6f6f6f @endif "
                                id="price"><span style="font-weight: bold">{{ $Data->category->prices->$price }}
                                </span> {{ __('general.sar') }}
                            </div>
                        </div>
                        @if ($Data->category->discount)
                            <div class="flex-row space-between" style="display: flex; justify-content: space-between;">
                                ...
                                <div id="price"><span
                                        style="font-weight: bold">{{ $Data->category->discount->$price - $Data->category->discount->$price * 0.15 }}
                                    </span>
                                    {{ __('general.sar') }}
                                </div>
                            </div>
                        ...
                        <div class="flex-row space-between" style="display: flex; justify-content: space-between;">
                            ...
                            <div id="tax"><span
                                    style="font-weight: bold">{{ ($Data->category->discount ? $Data->category->discount->$price : $Data->category->prices->$price) * 0.15 }}
                                </span>
                        ...
                        <div class="flex-row space-between" style="display: none; justify-content: space-between;"
                            ...
                            <div id="tamara-tax"><span style="font-weight: bold"
                                                       id="texTamara">{{ ($Data->category->discount ? $Data->category->discount->$price : $Data->category->prices->$price) * 0.07 }}
                                </span> {{ __('cart.sar') }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex-row space-between"
                            ...
                            <div style="font-weight: bold; display: flex; align-items: center;">
                                <span id="totalAmount" style="font-weight: bold">
                                    {{ $Data->category->discount ? $Data->category->discount->$price ?? '0' : $Data->category->prices->$price ?? '0' }}
                                </span>&nbsp;
