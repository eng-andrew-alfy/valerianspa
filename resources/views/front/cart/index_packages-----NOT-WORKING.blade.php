...
@section('content-front')
    ...
    <div class="cart-container">
        <form id="bookingForm" action="{{ route('PaymentMyFatoorah') }}" method="post">
            @csrf
            ...
            <div class="cart">
                <div class="cart-items-container">
                    ...
                    <div class="and-container">
                        <div class="and-item">
                            <div style="color: red" class="location-container">
                                <div class="header">
                                    <div class="circle">
                                        <span>3</span>
                                    </div>
                ...
                <div class="cart-footer-container">
                    <div class="title">
                        ...
                        <p><strong style="font-size: 15px">{{ __('cart.invoice_num') }}&nbsp;:&nbsp;</strong> &nbsp;
                            <strong style="font-size: 12px; display: inline-block;"
                                class="font-14 font-bold">{{ 21 }}</strong>
                        </p>
                    </div>
                    ...
                    <div class="price-sum d-col-flex font-14">
                        <div class="d-col-flex gap-10px border-b padding-b-10">
                            <div class="d-row-flex justify-between">
                                ...
                                <div><span
                                        class="weight-600 font-16">{{ $Data->package->prices->at_home - $Data->package->prices->at_home * 0.15 }}</span>
                                    {{ __('cart.sar') }}
                                </div>
                            </div>
                            <div class="d-row-flex justify-between">
                                <div class="font-bold">{{ __('cart.discount') }}</div>
                                <div><span class="weight-600 font-16" id="discount_show">0.00</span> {{ __('cart.sar') }}
                                </div>
                            </div>
                            <div class="d-row-flex justify-between">
                                <div class="font-bold">{{ __('cart.vat') }}</div>
                                <div><span class="weight-600 font-16">{{ $Data->package->prices->at_home * 0.15 }}</span>
                            ...
                            <div class="d-row-flex justify-between" id="tamaraExtraInfo" style="display: none;">
                                ...
                                <div><span class="weight-600 font-16"
                                        id="texTamara">{{ $Data->package->prices->at_home * 0.07 }}</span>
                                    {{ __('cart.sar') }}
                                </div>
                            </div>
                        </div>
                        <div class="d-row-flex justify-between padding-t-10">
                            ...
                            <div><span class="weight-600 font-16"
                                    id="totalAmount">{{ $Data->package->prices->at_home }}</span> {{ __('cart.sar') }}
                            </div>
                        </div>
                    </div>
            ...
            $(document).ready(function() {
                ...
                function updateTotalAmount() {
                    ...
                    if ($('#tamaraRadio').is(':checked')) {
                        ...
                        $('#bookingForm').attr('action', '{{ route('PaymentTAMARA') }}');
                    } else {
                        $('#tamaraExtraInfo').css('display', 'none');
                        $('#bookingForm').attr('action', '{{ route('PaymentMyFatoorah') }}');
                    }
