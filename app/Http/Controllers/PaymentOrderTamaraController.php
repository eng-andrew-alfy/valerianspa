<?php
    ...
    class PaymentOrderTamaraController extends Controller
    {

        public function storeOrder(StoreOrderRequest $request, TamaraService $tamaraService)
        {
        ...
        private function getAddress(Request $request)
        {
            ...
            $options = [
                'http' => [
                    'header' => "User-Agent: VALRANIA/1.0 (yourname@example.com)\r\n"
                ]
            ];
