...
(function (e) {
    ...
    function v(b, c, a) {
        ...
        !b.cells({ selected: !0 }).any() && !a
            ? ((d = d(0, c.column)), (a = f(0, c.row)))
            : ((d = d(a.column, c.column)), (a = f(a.row, c.row)));
        a = b.cells(a, d).flatten();
        b.cells(c, { selected: !0 }).any()
            ? b.cells(a).deselect()
            : b.cells(a).select();
    }
    function r(b) {
    ...
    function x(b) {
        ...
        c.on("mousedown.dtSelect", d, function (a) {
            ...
            .on("click.dtSelect", d, function (a) {
                ...
                if (!j.getSelection || !j.getSelection().toString()) {
                    var d = b.settings()[0];
                    if (
                        e(a.target).closest("div.dataTables_wrapper")[0] ==
                        b.table().container()
                    ) {
                        ...
                        if (g.any()) {
                            ...
                            h.isDefaultPrevented() ||
                                ((h = g.index()),
                                "row" === c
                                    ? ((c = h.row), s(a, b, d, "row", c))
                                    : "column" === c
                                    ? ((c = g.index().column),
                                      s(a, b, d, "column", c))
                                    : "cell" === c &&
                                      ((c = g.index()), s(a, b, d, "cell", c)),
        ...
        e("body").on("click.dtSelect", function (c) {
            a._select.blurable &&
                ...
                (e(c.target).parents("div.DTE").length || p(a, !0));
        });
    }
    function i(b, c, a, d) {
    ...
    function z(b, c, a, d) {
        ...
        b[c](a, { selected: !0 }).any()
            ? (f.splice(e.inArray(a, f), 1), b[c + "s"](f).deselect())
            : b[c + "s"](f).select();
    }
    function p(b, c) {
    ...
    function s(b, c, a, d, f) {
        var e = c.select.style(),
            k = c[d](f, { selected: !0 }).any();
        "os" === e
            ? b.ctrlKey || b.metaKey
                ? c[d](f).select(!k)
                : b.shiftKey
                ? "cell" === d
                    ? v(c, f, a._select_lastCell || null)
                    : z(
                          c,
                          d,
                          f,
                          a._select_lastCell ? a._select_lastCell[d] : null
                      )
                : ((b = c[d + "s"]({ selected: !0 })),
                  k && 1 === b.flatten().length
                      ? c[d](f).deselect()
                      : (b.deselect(), c[d](f).select()))
            : "multi+shift" == e
            ? b.shiftKey
                ? "cell" === d
                    ? v(c, f, a._select_lastCell || null)
    ...
    g.select.init = function (b) {
        ...
        if (!0 === a) (f = "os"), (i = !0);
            ...
            e.isPlainObject(a) &&
            (a.blurable !== h && (m = a.blurable),
            a.info !== h && (k = a.info),
            a.items !== h && (d = a.items),
            a.style !== h && ((f = a.style), (i = !0)),
        ...
        !i &&
            e(b.table().node()).hasClass("selectable") &&
            b.select.style("os");
    };
    e.each(
        [
    ...
    g.ext.selector.cell.push(function (b, c, a) {
        ...
        for (var e = 0, g = a.length; e < g; e++)
            (d = b.aoData[a[e].row]),
                ((!0 === c &&
                    d._selected_cells &&
                    !0 === d._selected_cells[a[e].column]) ||
                    (!1 === c &&
                        (!d._selected_cells ||
                            !d._selected_cells[a[e].column]))) &&
                    f.push(a[e]);
        return f;
    });
        ...
        this.iterator("column", function (c, a) {
            ...
            b.cells(null, a)
                ...
                .each(function (a) {
                    ...
                    b.anCells &&
                        (!d || !d[a.column]) &&
                        e(b.anCells[a.column]).removeClass(c._select.className);
                });
        });
        this.iterator("table", function (c, a) {
    ...
    o("cells().deselect()", "cell().deselect()", function () {
        ...
        this.iterator("cell", function (c, a, b) {
            ...
            a.anCells &&
                ...
                e(a.anCells[b]).removeClass(c._select.className);
        });
        this.iterator("table", function (c, a) {
