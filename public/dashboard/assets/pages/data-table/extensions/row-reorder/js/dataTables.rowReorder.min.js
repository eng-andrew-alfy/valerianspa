...
(function (e) {
    ...
    e.extend(j.prototype, {
            ...
            var c = this.s.dt,
                ...
                a = e.map(d, function (a, b) {
                    return d.length < b - 1
                        ...
                        : (a +
                              a +
                              e(c.row(":last-child").node()).outerHeight()) /
                              2;
                });
            this.s.middles = a;
        ...
        _clone: function (c) {
            var b = e(this.s.dt.table().node().cloneNode(!1))
        ...
        _mouseMove: function (c) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== d)
                0 === d
                    ...
                    : ((b = e.unique(
                          h.rows({ page: "current" }).nodes().toArray()
                      )),
                      d > this.s.lastInsert
                          ? this.dom.target.insertAfter(b[d - 1])
                          : this.dom.target.insertBefore(b[d])),
                    this._cachePositions(),
                    (this.s.lastInsert = d);
            this._shiftScroll(c);
        },
