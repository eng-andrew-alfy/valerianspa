...
(function (e) {
    ...
    e.extend(n.prototype, {
        ...
        _constructor: function () {
            ...
            if (this.c.blurable)
                e(k).on("mousedown.keyTable", function (c) {
        ...
        _editor: function (a, b) {
            ...
            16 !== a &&
                ...
                d.inline(this.s.lastFocus.cell.index()),
        ...
        _focus: function (a, b, c, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== f.length && (a < f.start || a >= f.start + f.length))
                    ...
                    if (c === o || !0 === c)
                        this._scroll(e(m), e(k.body), g, "offset"),
                            (c = h.table().body().parentNode),
                            c !== h.table().header().parentNode &&
                                ((c = e(c.parentNode)),
                                this._scroll(c, c, g, "position"));
                    this.s.lastFocus = {
                        cell: f,
                        node: f.node(),
                        relative: {
