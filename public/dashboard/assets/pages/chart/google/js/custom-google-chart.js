...
$(document).ready(function () {
    ...
    function drawChartStacking() {
        ...
        var chart = new google.visualization.AreaChart(
            document.getElementById("chart_stacking")
        );
    ...
    function drawSeriesChart() {
        ...
        var chart = new google.visualization.BubbleChart(
            document.getElementById("chart_bubble")
        );
        chart.draw(data, options);
    }
    ...
    function drawChartWaterfall() {
        ...
        var chart = new google.visualization.CandlestickChart(
            document.getElementById("chart_Waterfall")
        );
    ...
    function drawChartExploading() {
        ...
        var chart = new google.visualization.PieChart(
            document.getElementById("chart_Exploading")
        );
    ...
    function drawChartThreshold() {
        ...
        var chart = new google.visualization.PieChart(
            document.getElementById("chart_Threshold")
        );
