$(document).ready(function () {
    ...
    var chart,
        ...
        serie1 = [
            13, 13, 46, 61, 23, 12, 24, 16, 14, 12, 12, 24, 19, 13, 11, 11, 14,
            11, 11, 11, 11, 13, 22, 10, 18, 15, 24, 31, 19, 10,
        ],
        serie2 = [
            52, 41, 58, 63, 55, 46, 45, 41, 38, 54, 50, 39, 48, 70, 63, 60, 58,
            63, 83, 89, 83, 79, 83, 100, 104, 108, 52, 46, 83, 89,
        ],
        $aapls;
                ...
                series: [
                    {
                        ...
                        data: [
                            { value: 35, name: "Micromax" },
                            { value: 16, name: "Xolo" },
                            { value: 27, name: "Lenevo" },
                            { value: 29, name: "Sony" },
                ...
                series: [
                    {
                        ...
                        type: "pie",
                        data: [
                            { value: 42, name: "Micromax" },
                            { value: 51, name: "Xolo" },
                            { value: 39, name: "Lenevo" },
                            { value: 25, name: "Sony" },
                            { value: 9, name: "Others" },
                        ],
                    },
                ...
                series: [
                    {
                        ...
                        type: "pie",
                        data: [
                            { value: 29, name: "Micromax" },
                            { value: 16, name: "Xolo" },
                            { value: 24, name: "Lenevo" },
                            { value: 19, name: "Sony" },
                            { value: 5, name: "Others" },
                        ],
                    },
