document.addEventListener("DOMContentLoaded", function () {
    ...
    function getDateData() {
        return [
            ...
            ["Opel", "Astra", "02/02/2015", 7e3],
            ["BMW", "320i Coupe", "07/24/2024", 30500],
        ];
    }
    function getTimeData() {
        return [
            ["Mercedes", "A 160", 13322844e5, 6999.9999],
            ["Citroen", "C4 Coupe", "10 30", 8330],
            ["Audi", "A4 Avant", "8:00 PM", 33900],
            ["Opel", "Astra", 13322844e5, 7e3],
            ["BMW", "320i Coupe", 13322844e5, 30500],
        ];
    }
    ...
    var hotNumericData,
        containerNumericData = document.getElementById("numericData");
    ...
    var hotTimeData,
        containerTimeData = document.getElementById("timeData");
    ...
    var hotCheckboxData,
        checkboxCheckboxData = document.getElementById("checkbox");
    ...
    var hotCheckboxData,
        containerCheckboxData = document.getElementById("select");
    ...
    var hotDropdown,
        containerDropdown = document.getElementById("dropdown");
    ...
    var hotAutocomplete,
        containerAutocomplete = document.getElementById("autocomplete");
    ...
    var hotPassword,
        containerPassword = document.getElementById("password");
