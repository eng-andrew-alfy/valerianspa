 ...
 * validate.js 0.11.1
 *
 * (c) 2013-2024 Nicklas Ansman, 2013 Wrapp
        ...
        async: function (attributes, constraints, options) {
            ...
            return new v.Promise(function (resolve, reject) {
                v.waitForResults(results).then(
                    function () {
                        var errors = v.processValidationResults(
                            results,
                            options
                        );
                        if (errors) {
            ...
            for (i = 0; i < inputs.length; ++i) {
                ...
                if (input.multiple) {
                    ...
                    for (j in input.options) {
                        ...
                        if (option.selected) {
                            value.push(
                                v.sanitizeFormValue(option.value, options)
                            );
                        }
                    }
                } else {
        ...
        convertErrorMessages: function (errors, options) {
            ...
            errors.forEach(function (errorInfo) {
                ...
                if (error[0] === "^") {
                    ...
                    error =
                        v.capitalize(v.prettify(errorInfo.attribute)) +
                        " " +
                        error;
                }
